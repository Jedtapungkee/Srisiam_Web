...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="flex-1 md:w-1/2 flex items-center justify-center px-4 sm:px-6 md:px-8 lg:px-16 py-6 sm:py-8 lg:py-12 bg-white order-2 md:order-1">
      ...
      <div className="md:w-1/2 bg-gradient-to-br from-[#001F3F] to-[#003366] flex items-center justify-center p-4 sm:p-6 md:p-8 lg:p-16 relative overflow-hidden lg:rounded-l-[100px] order-1 md:order-2">
        {/* Decorative blob */}
        <div className="absolute top-0 left-0 w-32 h-32 sm:w-48 sm:h-48 md:w-64 md:h-64 lg:w-96 lg:h-96 bg-blue-500/20 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 right-0 w-32 h-32 sm:w-48 sm:h-48 md:w-64 md:h-64 lg:w-96 lg:h-96 bg-blue-600/20 rounded-full blur-3xl"></div>
