...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="lg:w-1/2 bg-gradient-to-br from-[#001F3F] to-[#003366] flex items-center justify-center p-8 lg:p-16 relative overflow-hidden lg:rounded-r-[100px]">
        {/* Decorative blob */}
        <div className="absolute top-0 right-0 w-64 h-64 lg:w-96 lg:h-96 bg-blue-500/20 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 left-0 w-64 h-64 lg:w-96 lg:h-96 bg-blue-600/20 rounded-full blur-3xl"></div>
      ...
      <div className="flex-1 lg:w-1/2 flex items-center justify-center px-6 py-8 lg:px-16 lg:py-12 bg-white">
        <div className="w-full max-w-md">
          ...
          <div className="space-y-3">
            ...
            <button
              onClick={logingoogle}
              className="w-full flex items-center justify-center px-4 h-12 border border-gray-300 rounded-lg bg-white text-gray-700 font-medium hover:bg-gray-50 transition-all duration-200"
            >
              {/* Google Icon */}
